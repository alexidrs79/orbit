 ...
 * The admin menu page itself is registered by acf_add_options_page() in
 * inc/acf-fields-theme-settings.php.
 */
...
add_action( 'acf/save_post', 'orbit_sync_favicon_to_site_icon', 20 );

function orbit_sync_favicon_to_site_icon( $post_id ) {
	if ( (string) $post_id !== (string) ORBIT_THEME_SETTINGS_PAGE_ID ) {
		return;
	}
